...
const createSiteFilterComponent = () => {
  return (
...
render(siteHeaderInfo, createRouteComponent(), `afterbegin`);
...
new Array(RENDER_COUNT).fill(``).map(() => render(routesList, createRoutesItem()));

const eventsList = routesList.querySelector(`.trip-events__list`);
render(eventsList, createEventForm());
